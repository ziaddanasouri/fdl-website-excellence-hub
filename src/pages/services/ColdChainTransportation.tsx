    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-primary mb-6">
                Pharmaceutical Company Achieves Zero Temperature Excursions
              </h2>
              <p className="text-muted-foreground mb-6">
                A leading pharmaceutical distributor needed guaranteed cold chain integrity for 
                temperature-sensitive medications across the Northeast. After switching to our 
                refrigerated transportation network:
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <TrendingUp className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>Zero excursions</strong> across 500+ shipments in 12 months</span>
                </div>
                <div className="flex items-center">
                  <Award className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>100% FDA compliance</strong> with automated documentation</span>
                </div>
                <div className="flex items-center">
                  <BarChart3 className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>40% cost reduction</strong> vs. previous carrier</span>
                </div>
                <div className="flex items-center">
                  <Users className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>Customer satisfaction</strong> improved to 99.2%</span>
                </div>
              </div>
              <Button>
              ...
              <Card className="border-0 shadow-xl">
                <CardContent className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground">Temperature Excursions</p>
                    <p className="text-sm text-green-600 font-medium">500+ shipments monitored</p>
                  </div>
                  <div className="grid grid-cols-2 gap-6 text-center">
                    <div>
                      <div className="text-2xl font-bold text-primary">100%</div>
                      <div className="text-xs text-muted-foreground">FDA Compliance</div>
                    </div>
                    <div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Calculate Transportation Costs</h2>
          <p className="text-xl text-blue-100 mb-8">
            Get instant quotes for cold chain transportation across the Northeast
          </p>
      ...
      <section className="py-20 logistics-gradient text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Secure Your Cold Chain?</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Trust your temperature-sensitive shipments to our proven transportation network. 
            Get guaranteed cold chain integrity with real-time visibility.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-primary hover:bg-blue-50 font-semibold">
