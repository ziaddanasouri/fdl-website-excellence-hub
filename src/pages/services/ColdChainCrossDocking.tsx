    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-primary mb-6">
                Food Distributor Reduces Transfer Time by 75%
              </h2>
              <p className="text-muted-foreground mb-6">
                A major food distributor needed to consolidate shipments from multiple suppliers 
                for retail delivery. Our cross-dock solution delivered impressive results:
              </p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <Clock className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>75% faster</strong> transfer times (8 hours to 2 hours)</span>
                </div>
                <div className="flex items-center">
                  <Award className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>Zero temperature excursions</strong> across all transfers</span>
                </div>
                <div className="flex items-center">
                  <BarChart3 className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>35% cost reduction</strong> in logistics operations</span>
                </div>
                <div className="flex items-center">
                  <Users className="h-5 w-5 text-green-600 mr-3" />
                  <span><strong>98% customer satisfaction</strong> with delivery performance</span>
                </div>
              </div>
              <Button>
              ...
              <Card className="border-0 shadow-xl">
                <CardContent className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground">Faster Transfer Times</p>
                    <p className="text-sm text-green-600 font-medium">From 8 hours to 2 hours</p>
                  </div>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Previous process:</span>
                      <span className="font-semibold">8 hours average</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Our cross-dock:</span>
                      <span className="font-semibold text-green-600">2 hours average</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground">Temperature excursions:</span>
                      <span className="font-semibold text-green-600">0 incidents</span>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Calculate Cross-Dock Savings</h2>
          <p className="text-xl text-purple-100 mb-8">
            See how our cross-docking services can reduce your logistics costs and transfer times
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-primary hover:bg-purple-50">
              Launch Savings Calculator
              <Calculator className="ml-2 h-5 w-5" />
            </Button>
            <Button variant="hero" size="lg">
              Download Cross-Dock Guide
      ...
      <section className="py-20 logistics-gradient text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Optimize Your Cross-Dock Operations?</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Eliminate cold chain breaks and reduce transfer times with our advanced 
            cross-docking facilities. Contact us to schedule your first transfer.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-primary hover:bg-blue-50 font-semibold">
              Schedule Cross-Dock Service
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button variant="hero" size="lg">
              <Phone className="mr-2 h-5 w-5" />
              Call Operations: (555) 123-4567
            </Button>
          </div>
        </div>
      </section>
